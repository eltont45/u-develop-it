...
VALUES
  ('JS Juggernauts', 'The JS Juggernauts eat, breathe, and sleep JavaScript. They can build everything that you could ever want in JS, including a new kitchen sink.'),
